...
interface SectionFilterComponentProps {
  ...
  setLessons: React.Dispatch<React.SetStateAction<TLessonSchema[]>>;
...
const SectionByDeptIdGenericLessonFilterComponent: React.FC<
    ...
    if (
      ...
      const listOfLessons = async () => {
        try {
          ...
          const res = await getGenericLessonsByGrade(Number(gradeId));
          console.log(res);
          setLessons(res);
...
export default SectionByDeptIdGenericLessonFilterComponent;
