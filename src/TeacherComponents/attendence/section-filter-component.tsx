...
import { Grade } from "@/AcademicsComponents/gradeSetup/data/schema";
...
import { TSectionNewSchema } from "./attendence.types";

import { getSelectedLessonsBySection } from "@/serverTeacher/lessonManagement/lesson/action";
import { Department, TAssignedLessonsSchema } from "@/schemas";
